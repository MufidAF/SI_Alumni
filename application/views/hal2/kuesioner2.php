<section class="content">
    ...
    <div class="box-body">
        <div class="box box-primary">
            <!-- /.box-header -->
            <div class="box-body">
            <?php if($this->fungsi->nokq()->no == 3) { ?>
                <div class="box-header with-border">
                        <label><h5><b>Terima Kasih Karena Telah Melakukan Pengisian Kuesioner kegiatan... <i class="fa fa-smile-o"></i></b></h5></label>
                        <p><h5><b>Jika ingin melakukan Pembaruan data kuesioner Klik tombol di bawah...</b></h5></p>
                        <a href="<?=base_url('user/viewkq')?>"><i class="fa fa-circle-o"></i> Perbarui Data Kuesioner</a>
                    </div>
                    <?php }
               else { ?>
                ...
                <form action="<?=base_url('Dasboard/tbjawab2');?>" method="post">
