...
<head>
  ...
  <title>Laporan Alumnin SMA Negeri 1 Gadingrejo</title>
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="" class="navbar-brand"><b>Laporan Alumni | </b>SMA Negeri 1 Gadingrejo</a>
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                    <a href= "<?= base_url('user/laporan')?>" class="btn btn-warning">Back</a>
                </div>
          </div>
          <div class="box-body">
